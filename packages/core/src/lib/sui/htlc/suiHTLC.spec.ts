...
import { ApiKey, DigestKey, Environment, Network, Url } from '@gardenfi/utils';
...
describe.only('sui htlc init tests', () => {
  ...
  const create_order: CreateOrderReqWithStrategyId = {
    ...
    destination_asset:
      '2wxpy8havgjfrxme9luxtjfhth1efu3ur4v6wik4kdnc_5jbwjyldyktuykpq2itwbdrczkhk3hs6fih62pkmlyzi',
    source_amount: '3000000000',
    destination_amount: '206237',
    nonce: '1753963050221',
    initiator_source_address:
      '0x2b021d7aa1d4b7b57d1b931f8e12007537a340b5f9f540e7beee25b4bd65aa5c',
    initiator_destination_address:
      '6wpsRMVPfX8uJB9SRZF6n8HXZQ79gBrVzM5W8epTdWE5',
    additional_data: {
      strategy_id: 'st44stcn',
    },
    affiliate_fees: [],
  };
  let garden: Garden;
