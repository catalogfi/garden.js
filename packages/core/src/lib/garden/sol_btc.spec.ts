...
describe('==========BTC <--> SOL===========', () => {
    ...
    const btcWallet = BitcoinWallet.fromPrivateKey("3cd7c7cd08c2eb6aeac37e5654a05ebc2e92afe0adf109ea0c615c7cb8d9831f", bitcoinProvider);
    ...
    async function fundBTC(to: string): Promise<void> {
        ...
        console.log("Successfully submitted at http://localhost:5050/tx/" + dat.txId);
    }
