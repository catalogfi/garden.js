...
// Create a custom Arbitrum Sepolia configuration with a compatible RPC
const updatedArbitrumSepolia = {
  ...arbitrumSepolia,
  rpcUrls: {
    default: {
      http: [
