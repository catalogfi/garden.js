...
export type AffiliateFeesWithAmount = AffiliateFees & {
  amount: string;
};

export type AffiliateFeesConfig = {
  affiliate_fees?: AffiliateFees[];
};

export type AffiliateFeesConfigWithAmount = {
