  ...
  return (
    <div style={{ display: "flex", gap: "10px" }}>
      <div style={{ textAlign: "center" }}>
        <img src={mainColorway} alt="Main Colorway" style={{ width: "17rem" }} />
        <p style={{ fontWeight: "bold" }}>Main Colorway</p>
        <p>Background: #7BDCBA</p>
        <p>Gradient: #9BC8FF</p>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src={altColorway1} alt="Alt Colorway 1" style={{ width: "17rem" }} />
        <p style={{ fontWeight: "bold" }}>Alt Colorway 1</p>
        <p>Background: #8DCOFF</p>
        <p>Gradient: #FFBBD3</p>
      </div>
      <div style={{ textAlign: "center" }}>
        <img src={altColorway2} alt="Alt Colorway 2" style={{ width: "17rem" }} />
