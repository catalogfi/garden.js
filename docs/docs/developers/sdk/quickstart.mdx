...
The code snippet below swaps your BTC to WBTC on Ethereum. To understand what's happening at each step, take a look at [swapping from BTC to WBTC guide](./guides/btc-to-wbtc).
